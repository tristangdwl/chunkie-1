...
sys_R = build_dirichlet_sys_cap(nover,d_L,1,zk);
...
fkern_S = @(s,t) d_guide_kern(s,t,sys_L,'s')-d_guide_kern_cap(s,t,sys_R,'s');
...
fkern_Sp = @(s,t) d_guide_kern(s,t,sys_L,'sp')-d_guide_kern_cap(s,t,sys_R,'sp');

fkern_Dp = @(s,t) d_guide_kern(s,t,sys_L,'dp')-d_guide_kern_cap(s,t,sys_R,'dp');
opdims(1) = 1; opdims(2) = 1;
opts = [];
...
uscat(ir) = d_guide_kern_lump_cap(ssrc,dsrc,targr,sys_R);
toc
...
chnkrR = real(sys_R.chnkr.r(:,:)); chnkrR(:,chnkrR(1,:)<0) = NaN;
    hold on
